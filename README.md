...
![V2EX Playground 主界面预览](https://files.seeusercontent.com/2026/07/21/m9Hy/pasted-image-1784601716752.webp)
...
- 话题浏览：查看首页、自定义节点、收藏节点、节点主题和标签主题，也可通过话题 ID 或链接直接打开话题
- 话题详情：阅读主题内容和回复，支持站内话题就地预览、代码高亮、嵌入视频外部打开、楼中楼/列表切换、用户快捷资料、回复中的 MOD/OP/PRO 标识和多图预览切换
- 最近浏览：搜索、打开或删除最近查看过的话题
- 回复与互动：回复话题（支持预览、图片上传和表情）、收藏话题，以及感谢主题或回复
- 内容操作：通过右键菜单复制标题或链接，也可用浏览器打开内容；话题支持生成分享长图，图片支持预览、隐藏和下载
