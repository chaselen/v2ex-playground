/**
 * 图片表情源地址
 * @see https://github.com/coolpace/V2EX_Polish/blob/main/src/constants.ts
 */
export const imageEmoticonSources = {
  '[脱单doge]': {
...
/** 图片表情链接 */
export const imageEmoticonLinks = Object.fromEntries(
 ...
 * @param value 表情文本
 */
export function isImageEmoticon(value: string): value is ImageEmoticonToken {
  return value in imageEmoticonLinks
}
 ...
 * @param src 图片地址
 */
export function isImageEmoticonSrc(src: string) {
  try {
